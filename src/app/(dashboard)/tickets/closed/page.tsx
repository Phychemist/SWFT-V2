...
import { RotateCcw, Search, Eye, Copy, Check, Filter, X, Activity, Stethoscope, MapPin, User as UserIcon } from 'lucide-react'
    ...
    return (
        <div className="animate-fade-in space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-[var(--text-primary)]">Closed Tickets</h1>
                    <p className="text-[var(--text-secondary)]">View all tickets in "Submitted and closed" stage</p>
                </div>
            ...
            <Card>
                ...
                <Table
                    ...
                    data={tickets}
                    loading={loading}
                    emptyMessage="No closed tickets found"
